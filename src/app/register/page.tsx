      ...
      <div className="hidden lg:flex w-[55%] h-full flex-col justify-center px-16 xl:px-24 z-10 pointer-events-none">
        <div className="relative">
          ...
          <p className="font-k2d mt-6 text-gray-400 text-lg leading-relaxed max-w-xl">
            Create your account today and unlock a world of endless music.
            Connect with artists, curate your playlists, and experience sound
            like never before.
          </p>
        </div>
      </div>
        ...
        <div className="flex-1 w-full flex flex-col items-center justify-center px-6 sm:px-12 overflow-y-auto overflow-x-hidden custom-scrollbar">
          ...
          <div className="w-full max-w-[450px] backdrop-blur-xl bg-black/40 border border-white/10 rounded-2xl px-6 py-2 sm:px-8 sm:py-5 shadow-2xl relative overflow-hidden shrink-0 my-auto">
            ...
            <div className="space-y-3">
              ...
              {/* Terms Checkbox */}
              <div
                className="flex items-center gap-2 pt-1 cursor-pointer group"
                onClick={() => setAgreeOurPolicy(!agreeOurPolicy)}
              >
                <div
                  className={`w-4 h-4 shrink-0 rounded border flex items-center justify-center transition-all duration-200 ${agreeOurPolicy ? "bg-cyan-500 border-cyan-500" : "border-gray-500 bg-transparent group-hover:border-cyan-400"}`}
                >
                  {agreeOurPolicy && (
                    <svg
            ...
            <div className="mt-2 text-center">
              ...
              >
                ...
                <span className="text-cyan-400 font-semibold ml-1">Login</span>
              </button>
            </div>
          </div>
        </div>
